...
<div class="modal-body">
    <form  class="form-horizontal" method="POST" action="{{ url('/organization/administrator/events/store') }}" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class="input-group startdtp" id="startdtp">
                    <input type="text" placeholder="M/D/YYYY HH:MM AM/PM" class="form-control start_date_modal" name="start_date2" id="start_date" value="{{ (old('start_date2'))? old('start_date2') :  $start_date }}" required="required">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class='input-group enddtp' id="enddtp">
                    <input type="text" placeholder="M/D/YYYY HH:MM AM/PM" class="form-control end_date_modal" name="end_date2"  value="{{ (old('end_date2'))? old('end_date2') :  $end_date }}" id="end_date" required>
                    <span class="input-group-addon">
            ...
            <div class="col-md-11">
                <div class="clearfix">
                    <div class="pull-right">
                        ...
                        Make this as a Recurring Event
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-group volunteer-panel">
            <div class="col-md-12 text-left">
                <label>
                 ...
                 {{--    <a id="add-volunteer-group" href="javascript:void(0);" class="btn btn-darkblue btn-right" data-action="{{ route('generate_volunteer_group') }}">+</a> --}}
            ...
            <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" id="small-modal">
                <div class="modal-dialog modal-lg modal-md hidden-xs" role="document">
                    <div class="modal-content" style="text-align: center;">
                        ...
                        <label>Choose which event dates you want to update:</label>
                        <br><br>
                        <input type="radio" name="edit_as" value="1">This event only
                        <br>
            ...
            <div class="btn-right">
                ...
                @if($id >0 && $recurring > 0)
                <a href="" class="btn btn-darkblue float-right " data-toggle="modal" data-target=".bs-example-modal-sm">Submit</a>
                @else
                <button type="submit" id="event-submit" class="btn btn-darkblue float-right">
                    Submit
                </button>
                @endif
        ...
        <div class="modal fade" id="myModalStart2"tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
$(document).ready(function(){
    ...
    // $('#save_recurring_event').click(function(){
    ...
    // });
        ...
        // $('#reminder_date').keypress(function() {
        //     reminderDate();
        // });
        ...
        // if($('#start_date').val() != ''){
        //     $('#start_date').val((converted_start_date.getMonth()+1)+'/'+converted_start_date.getDate()+'/'+converted_start_date.getFullYear()+' ' + start_date_hour + ':' + start_date_minutes + ' ' + start_date_A);
        ...
        if($('#start_date').val() != ''){
            ...
            $('#start_date').val((hash_date.getMonth()+1)+'/'+hash_date.getDate()+'/'+hash_date.getFullYear()+' ' + start_date_hour + ':' + start_date_minutes + ' ' + start_date_A);
            ...
            $('#reminder_date').val((hash_date.getMonth()+1)+'/'+hash_date.getDate()+'/'+hash_date.getFullYear());
            ...
            var recurring_end_date =new Date('{{ $recurring_end_date_parse or '' }}');
            ...
            if(recurring == 2){
               var no_of_month_diff = (Math.floor(total_current_days)) / 31;
                ...
                $('#no_occurrence').val(no_of_occurrence -1);
            }else if(recurring == 1){
        ...
        // if($('#end_date').val() != ''){
        //     $('#end_date').val((converted_end_date.getMonth()+1)+'/'+converted_end_date.getDate()+'/'+converted_end_date.getFullYear()+' ' + end_date_hour + ':' + end_date_minutes + ' ' + end_date_A);
        // }
        if($('#end_date').val() != ''){
            var split_hash = (location.href.slice(location.href.lastIndexOf('#'))).substring(1);
            var arr = split_hash.split('/');
            var hash_date = new Date(arr[1]);
            //alert(hash_date);
            $('#end_date').val((hash_date.getMonth()+1)+'/'+hash_date.getDate()+'/'+hash_date.getFullYear()+' ' + end_date_hour + ':' + end_date_minutes + ' ' + end_date_A);
        ...
        $('.cb_event_recurring').click(function(){
            if($(this).prop("checked") == true){
                ...
                $('#date_until').val(_month+'/'+_day+'/'+_year );
                //$('.volunteer-panel').hide();//for temporary only, hiding for recurring event
            } else {
                $('#event-group').fadeOut("slow");
                $('#event-group-repeat').fadeOut("slow");
                $('.cb_event_recurring').val('0');
...
//weekly recurring
 ...
 /// Get Total no of Occurrence 
    ...
    monthly = function(){
        ...
        $('#date_until').val(_month+'/'+_day+'/'+_year );
        //get total occurrence based on year
       $('#date_until').attr('value', _month+'/'+_day+'/'+_year );
       var r =$('#date_until').attr('value');
       var recurring_end_date =  new Date(r);

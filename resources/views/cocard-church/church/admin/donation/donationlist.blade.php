...
<div class="d-content">
	<div class="margin-mob-top">
		<ul class="nav donation-nav">
			<li><a href="{{ url('/organization/'.$slug.'/administrator/donation-category')}}">Donation Category</a></li>
			<li class="active"><a href="{{ url('/organization/'.$slug.'/administrator/donation-list')}}">Donation List</a></li>
		</ul>
		<br>
		@if(session('success'))
				...
				<div class="table-main panel panel-default">
					<div class="table-responsive">
						<table class="table table-striped" id="tabledata">
							<thead class="theader">
								<th><a title = "Sort by Category" href="{{url('/organization/'.$slug.'/administrator/donation-list').'?order_by=name&sort='. $sort.'#category_list'}}">Category</a></th>
								<th><a title = "Sort by Name" href="{{url('/organization/'.$slug.'/administrator/donation-list').'?order_by=name&sort='. $sort.'#category_list'}}">Name</a></th>
								<th style="width: 30%;"><a title = "Sort by Decription" href="{{url('/organization/'.$slug.'/administrator/donation-list').'?order_by=description&sort='. $sort.'#category_list'}}">Description</a></th>
								{{--<th>Recurring</th>--}}
								<th>Status</th>

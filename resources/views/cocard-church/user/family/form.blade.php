...
<div class="d-content">
    <div class="margin-mob-top">
        <div class="row">
            ...
            <div class="col-md-6">
                <h3>
                    <a style="float:right;" href="{{ url('/organization/'.$slug.'/user/family')}}" class="btn btn-darkblue float-right">
                        ...
                        <div class="col-md-offset-2 col-md-9">
                            ...
                            <div class="clearfix">
                                <div class="pull-right">
                                    ...
                                    <a href="{{ url('organization/'. $slug .'/user/family') }}" class="btn btn-red">
                                        Cancel
                                    </a>
                                </div>
                            </div>

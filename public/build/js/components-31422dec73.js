...
loadEventDetails = function(event,token,dateClicked){
    $.post($(".calendar-modal").data("event_modal_url"),{id: event.id,slug:$("#event-modal").data("slug"),_token:token}).done(function(data){
        ...
        var value = $('.js-edit-event-hash').attr('href',$('.js-edit-event-hash').attr('href') + newvalue+'/'+event.count_);
                ...
                eventClick: function(event, jsEvent, view) {
                    ...
                    $(table).each(function(){
                        ...
                        if($(this).is('thead')){
                            ...
                            //alert(dateClicked);
                            loadEventDetails(event, token,'' + dateClicked);
                        }
                    });
...
$(function(){
    ...
    // Update of Volunteer Group Modal
...
//# sourceMappingURL=../build//js/components-31422dec73.js.map
